...
import { heads } from '../helpers/headers';
    ...
    const customHeaderRender = (headerProps) => {
        ...
        return (
            <div style={{ display: 'flex', justifyContent: 'space-between', padding: '1%' }}>
                ...
                <div style={{ fontSize: '1.5em', fontWeight: '750', 
                color: `#463F3A`
             }}
                >
        ...
        return (
            ...
            <>
                <div
                    ...
                    onClick={() => props.action(date.format('YYYY-MM-DD'), date.format('DD MMMM YYYY'))}
                    style={{

                        width: '100%', height: '100%',
                        alignItems: 'center', justifyContent: 'center',
                        backgroundColor: `#BCB8B140`, borderRadius:'2vh',
                ...
                <div
                    ...
                    style={{
                        ...
                        width: '100%', height: '100%', marginTop:'-3vh',
                        alignItems: 'center', justifyContent: 'center',
                        backgroundColor: `#BCB8B140`,position: 'absolute',borderRadius:'2vh',
